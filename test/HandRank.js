...
describe('HandRank', () => {
  it('detects royal flush', () => {
    ...
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.ACE);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.KING);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.QUEEN);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.TEN);
  ...
  it('detects straight flush', () => {
    ...
    expect(handrank.getRank()).to.equal(HandRank.STRAIGHT_FLUSH);
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.SIX);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.FIVE);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.THREE);
    ...
    expect(handrank.getRank()).to.equal(HandRank.STRAIGHT_FLUSH);
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.SIX);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.FIVE);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.THREE);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.TWO);
    ...
    expect(handrank.getRank()).to.equal(HandRank.STRAIGHT_FLUSH);
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.EIGHT);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.SIX);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.FIVE);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.FOUR);
  ...
  it('detects ace-low straight flush', () => {
    ...
    expect(handrank.getRank()).to.equal(HandRank.STRAIGHT_FLUSH);
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.FIVE);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.THREE);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.TWO);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.ACE);
  ...
  it('detects quads', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.TEN);
  ...
  it('detects fullhouse', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.FOUR);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.FOUR);
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.EIGHT);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.EIGHT);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.EIGHT);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.SEVEN);
  ...
  it('detects flush', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.QUEEN);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.NINE);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.TWO);
  ...
  it('detects straight', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.NINE);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.EIGHT);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.SIX);
  ...
  it('detects trips', () => {
    ...
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.NINE);
  ...
  it('detects two pairs', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.NINE);
    ...
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.SEVEN);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.ACE);
  ...
  it('detects pair', () => {
    ...
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.TEN);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.NINE);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.SEVEN);
  ...
  it('detects high card', () => {
    ...
    expect(handrank.getHighCards().length()).to.equal(5);
    expect(handrank.getHighCards().getCard(0).getRank()).to.equal(Rank.KING);
    expect(handrank.getHighCards().getCard(1).getRank()).to.equal(Rank.QUEEN);
    expect(handrank.getHighCards().getCard(2).getRank()).to.equal(Rank.JACK);
    expect(handrank.getHighCards().getCard(3).getRank()).to.equal(Rank.NINE);
    expect(handrank.getHighCards().getCard(4).getRank()).to.equal(Rank.SIX);
