...
describe('OddsCalculator (ties)', () => {
  ...
  it('no board #2', () => {
    ...
    const result = OddsCalculator.calculateEquity([player1Cards, player2Cards, player3Cards], null, 10000);
  ...
  it('one card left', () => {
    ...
    let result = OddsCalculator.calculateEquity([player1Cards, player2Cards, player3Cards], board);
